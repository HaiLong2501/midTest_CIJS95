...
import BodyMovie from "./BodyMovie/BodyMovie";
import spy_carousel_1 from "./assets/spy_carousel_1.png";
import One_piece_1 from "./assets/One_piece_1.png";
import boruto_naruto_next_generations_1 from "./assets/boruto_naruto_next_generations_1.png";
import spy_card_1 from "./assets/spy_card_1.png";
import attackontitan_1 from "./assets/attackontitan_1.png";
import captsu_card_1 from "./assets/captsu_card_1.png";
import aoashi_card_1 from "./assets/aoashi_card_1.png";
...
function App() {
  const [movieInfo, setMovieInfo] = useState([
    ...
    },
    {
      ...
      image: boruto_naruto_next_generations_1,
      episode: "250",
    },
    {
      id: 4,
  ...
  const [showMovie, setShow] = useState(movieInfo[0]);
          ...
          .map((item) => {
            return (
              <MovieRelease
                ...
                onMovieClick={() => handleMovieClick(item)}
              />
            );
          })}
      </div>
